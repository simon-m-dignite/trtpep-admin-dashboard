...
const CancelationPolicy = () => {
  ...
  useEffect(() => {
    const fetchPolicies = async () => {
      const res = await policyServices.fetchPrivacyPolicy("Cancelation Policy");
  ...
  return (
    <div className="w-full p-6 bg-gray-50 min-h-screen">
      <div className="w-full flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold mb-6">Cancelation Policy</h2>
        <Link
          to="/policy/update-cancelation-policy"
