...
import { fetchPharmaciesById, handleDeletePharmacies } from "../../services/pharmacies";

const DetailPharmaciesPage = () => {
  ...
  const handleDelete = async () => {
    try {
      alert(_id,"idsss")
      const res = await handleDeletePharmacies(_id);
    ...
    <div className="w-full p-6 bg-gray-50 min-h-screen">
      <div className="w-full flex items-center justify-between mb-6">
        ...
        <div className="flex items-center justify-end gap-4">
          <Link
            to={`/pharmacies/update-pharmacies/${_id}`}
...
export default DetailPharmaciesPage;
